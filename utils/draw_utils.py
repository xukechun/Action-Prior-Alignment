...
def aggr_point_cloud(database, sel_time=None, downsample=True):
    ...
    for i in range(start, end, step):
        ...
        mask = database.get_mask(id, sel_time=sel_time) & (depth > 0.0)
...
def aggr_point_cloud_from_data(colors, depths, Ks, poses, downsample=True, masks=None, boundaries=None, visualize=False):
